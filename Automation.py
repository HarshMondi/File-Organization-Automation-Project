...
dest_dir_documents = "D:\Downloads\Docs"

# ? supported image types
image_extensions = [".jpg", ".jpeg", ".png", ".gif", ".webp", ".tiff", ".tif", ".psd", ".raw", ".bmp", ".heif", ".heic", ".svg", ".eps", ".ico"]

# ? supported Video types
video_extensions = [".webm", ".mpg", ".mpeg", ".mp4", ".m4v", ".avi", ".wmv", ".mov", ".flv"]
